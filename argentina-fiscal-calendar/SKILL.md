...
2. **Siempre preguntar por terminación de CUIT** cuando el usuario no la especifique y el
   vencimiento sea CUIT-dependiente. Los últimos dos dígitos del CUIT determinan la fecha.
...
DÍA 9  → SUSS/F.931 CUIT 0,1,2,3 | Autónomos CUIT 7,8,9
